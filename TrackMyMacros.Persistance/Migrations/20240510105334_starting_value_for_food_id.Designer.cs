...
namespace TrackMyMacros.Persistance.Migrations
{
    ...
    [Migration("20240510105334_starting_value_for_food_id")]
    partial class starting_value_for_food_id
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Aggregates.DailyLimit.DailyLimits", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Calories = 2400,
                            CreatedDate = new DateTime(2024, 5, 10, 10, 53, 34, 304, DateTimeKind.Utc).AddTicks(1761),
                            LastModifiedDate = new DateTime(2024, 5, 10, 10, 53, 34, 304, DateTimeKind.Utc).AddTicks(1879),
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Aggregates.Day.Day", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("64e7844b-dcea-4d89-b199-97dc95bef1e1"),
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Aggregates.FoodCombo.FoodCombo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("16efaa9d-fc3f-4222-9de5-6238398ecc54"),
                            CreatedDate = new DateTime(2024, 5, 10, 10, 53, 34, 311, DateTimeKind.Utc).AddTicks(9221),
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Uom", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 10, 10, 53, 34, 313, DateTimeKind.Utc).AddTicks(5753),
                            LastModifiedDate = new DateTime(2024, 5, 10, 10, 53, 34, 313, DateTimeKind.Utc).AddTicks(5795),
                            Name = "Grams"
                        });
                });
                    ...
                    b.OwnsMany("TrackMyMacros.Domain.ValueObjects.Meal", "Meals", b1 =>
                        {
                            ...
                            b1.OwnsMany("TrackMyMacros.Domain.ValueObjects.FoodAmount", "FoodAmounts", b2 =>
                                {
                                    ...
                                    b2.HasData(
                                        new
                                        {
                                            MealDayId = new Guid("64e7844b-dcea-4d89-b199-97dc95bef1e1"),
                                            MealId = 1,
                                            Id = 1,
                                            Carbohydrate = 10.0,
                                            Fat = 10.0,
                            ...
                            b1.HasData(
                                new
                                {
                                    DayId = new Guid("64e7844b-dcea-4d89-b199-97dc95bef1e1"),
                                    Id = 1,
                    ...
                    b.OwnsMany("TrackMyMacros.Domain.ValueObjects.FoodComboAmount", "FoodComboAmounts", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    FoodComboId = new Guid("16efaa9d-fc3f-4222-9de5-6238398ecc54"),
                                    Id = 1,
                                    Carbohydrate = 10.0,
                                    Fat = 10.0,
                                    FoodId = 1,
