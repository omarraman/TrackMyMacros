...
namespace TrackMyMacros.Persistance.Migrations
{
    ...
    [Migration("20240328051152_Initial")]
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Aggregates.DailyLimit.DailyLimits", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Calories = 2400,
                            CreatedDate = new DateTime(2024, 3, 28, 5, 11, 51, 740, DateTimeKind.Utc).AddTicks(3528),
                            LastModifiedDate = new DateTime(2024, 3, 28, 5, 11, 51, 740, DateTimeKind.Utc).AddTicks(3685),
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Aggregates.Day.Day", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("78e3cc81-d047-4fef-81f8-e6944c9590d1"),
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Aggregates.FoodCombo.FoodCombo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8ff6a969-412f-4f69-9585-bdbc3871e60b"),
                            CreatedDate = new DateTime(2024, 3, 28, 5, 11, 51, 753, DateTimeKind.Utc).AddTicks(1306),
            ...
            modelBuilder.Entity("TrackMyMacros.Domain.Uom", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 3, 28, 5, 11, 51, 757, DateTimeKind.Utc).AddTicks(2233),
                            LastModifiedDate = new DateTime(2024, 3, 28, 5, 11, 51, 757, DateTimeKind.Utc).AddTicks(2636),
                            Name = "Grams"
                        });
                });
                    ...
                    b.OwnsMany("TrackMyMacros.Domain.ValueObjects.Meal", "Meals", b1 =>
                        {
                            ...
                            b1.OwnsMany("TrackMyMacros.Domain.ValueObjects.FoodAmount", "FoodAmounts", b2 =>
                                {
                                    ...
                                    b2.HasData(
                                        new
                                        {
                                            MealDayId = new Guid("78e3cc81-d047-4fef-81f8-e6944c9590d1"),
                                            MealId = 1,
                                            Id = 1,
                                            Carbohydrate = 10.0,
                                            Fat = 10.0,
                            ...
                            b1.HasData(
                                new
                                {
                                    DayId = new Guid("78e3cc81-d047-4fef-81f8-e6944c9590d1"),
                                    Id = 1,
                    ...
                    b.OwnsMany("TrackMyMacros.Domain.ValueObjects.FoodComboAmount", "FoodComboAmounts", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    FoodComboId = new Guid("8ff6a969-412f-4f69-9585-bdbc3871e60b"),
                                    Id = 1,
                                    Carbohydrate = 10.0,
                                    Fat = 10.0,
                                    FoodId = 1,
