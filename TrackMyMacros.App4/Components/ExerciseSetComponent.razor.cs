...
{
    public partial class ExerciseSetComponent
    {
        ...
        // {
        //     Mesocycle.FoodAmounts.Add(new FoodAmountViewModel { FoodId = -1, Quantity = 10 });
        //     StateHasChanged();
        // }
        //
        // private async Task RemoveFoodItem(FoodAmountViewModel foodAmount)
        // {
        //     Mesocycle.FoodAmounts.Remove(foodAmount);
        //     Mesocycle.RefreshTotals();
        ...
        // {
        //     var json = JsonConvert.SerializeObject(Mesocycle);
        ...
        // {
        //     Mesocycle.FoodAmounts.AddRange(mealViewModel.FoodAmounts);
        //     Mesocycle.RefreshTotals();
        //     await OnMealMacrosChanged.InvokeAsync();
        //     StateHasChanged();
        // }
